...
$busca = '%'.filter_var(@$_POST['buscar'], @FILTER_SANITIZE_STRING).'%';
$loja = filter_var(@$_POST['loja'], @FILTER_SANITIZE_STRING);
$categoria = filter_var(@$_POST['categoria'], @FILTER_SANITIZE_STRING);
if($categoria == "" || $categoria == "0"){
    $sql_cat = '';
}else{
    $sql_cat = " and categoria = '$categoria'";
}
                ...
                <div id="content" class="col-md-12 col-sm-8">
                    <div class="products-category">
                        ...
                        <div class="products-list row nopadding-xs so-filter-gird">
                             ...
                             <?php 
                  $query = $pdo->prepare("SELECT * from produtos where ativo = 'Sim' and (nome like :busca or palavras like :busca) $sql_cat $sql_loja order by nome asc LIMIT $limite, $itens_paginacao");
                  ...
                  if($linhas > 0){
                    ...
                    //trazer o total de registros para paginacao
                     $query2 = $pdo->prepare("SELECT * from produtos where ativo = 'Sim' and (nome like :busca or palavras like :busca) $sql_cat $sql_loja");
                                    ...
                                    <?php if($valor_promo > 0){ ?>   
                                      ...
                                      <?php } ?>
                                        <div class="button-group so-quickview cartinfo--left">
                                            <a href="produto-<?php echo $url ?>" type="button" class="addToCart btn-button" title="Add ao Carrinho"
                                    ...
                                    <span class="fa fa-stack"><i
                                        ...
                                        <span class="fa fa-stack"><i
                                            ...
                                            <div class="list-block" style="padding:0px">
                                                 <a type="button" class="addToCart btn-button cards_carrinho" title="Add ao Carrinho"
                                                href="produto-<?php echo $url ?>"> <i class="fa fa-shopping-basket"></i>
                                                <span>Add ao Carrinho </span>
                                            </a>
