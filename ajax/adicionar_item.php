...
$pdo->query("INSERT INTO temp SET sessao = '$sessao', tabela = '$tipo', id_item = '$id', carrinho = '0', data = curDate(), grade = '$grade', valor_item = '$valor', quantidade = '$quantidade', tipagem = '$tipagem', produto = '$produto'"); 
