...
$query2 = $pdo->query("SELECT * from categorias where url = '$url' $sql_cat");
$res2 = $query2->fetchAll(PDO::FETCH_ASSOC);
$id_cat = $res2[0]['id'];

$limite = $pag * @$itens_paginacao;
$pagina = $pag;
$nome_pag = 'categoria-'.$url.'-';
                ...
                <div id="content" class="col-md-12 col-sm-8">
                    <div class="products-category">
                        ...
                        <div class="products-list row nopadding-xs so-filter-gird">
                             ...
                             <?php 
                  $query = $pdo->prepare("SELECT * from produtos where ativo = 'Sim' and categoria = '$id_cat' order by nome asc LIMIT $limite, $itens_paginacao");
                  ...
                  if($linhas > 0){
                    ...
                    //trazer o total de registros para paginacao
                     $query2 = $pdo->prepare("SELECT * from produtos where ativo = 'Sim' and categoria = '$id_cat'");                 
                  $query2->execute();
                  $res2 = $query2->fetchAll(PDO::FETCH_ASSOC);
                                    ...
                                    <?php if($valor_promo > 0){ ?>   
                                      ...
                                      <?php } ?>
                                        <div class="button-group so-quickview cartinfo--left">
                                            <a  class="addToCart btn-button" title="Add ao Carrinho"
