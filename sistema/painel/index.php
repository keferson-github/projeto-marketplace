...
<head>
        ...
        <meta name="Author" content="Keferson">
...
<?php } ?>
			...
			<div class="main-footer">
				<div class="container-fluid pt-0 ht-100p">
					 Copyright 2024 © <?php echo date('Y'); ?> <a href="javascript:void(0);" class="text-primary">Desenvolvido por Grupo Web System</a>. Todos os direitos reservados. 
				</div>
			</div>			<!-- FOOTER END -->
