        ...
        <div class="module sohomepage-slider ">
            ...
            <div class="yt-content-slide">
              ...
              if($linhas > 0){                
                ...
                <a href="<?php echo $link1 ?>"><img src="sistema/painel_loja/images/banners/<?php echo $banner1 ?>" alt="slider1"
        ...
        <div class="modcontent">
            <div id="so_extra_slider_1" class="extraslider">
                ...
                <div class="item ">
                  ...
                  <?php 
                  $query = $pdo->query("SELECT * from produtos where ativo = 'Sim' and loja = '$id_usuario' order by id desc limit 10");
                  $res = $query->fetchAll(PDO::FETCH_ASSOC);
                  $linhas = @count($res);
                  if($linhas > 0){
                    for($i=0; $i<$linhas; $i++){
                ...
                <div class="slider-container row">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 col2">
                        <div class="module sohomepage-slider ">
                            ...
                            <div class="banners">
                                 <div class="b-img">
                                <a href="<?php echo $link1 ?>"><img src="sistema/painel_loja/images/banners/<?php echo $banner1 ?>"
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 col3">
                        <div class="modcontent clearfix">
                            <div class="banners banners1">
                                <div class="b-img">
                                    <a href="<?php echo $link2 ?>"><img src="sistema/painel_loja/images/banners/<?php echo $banner2 ?>" alt="banner2"></a>
                                </div>
                                <div class="b-img2">
                                    <a href="<?php echo $link3 ?>"><img src="sistema/painel_loja/images/banners/<?php echo $banner3 ?>" alt="banner3"></a>
                                </div>
