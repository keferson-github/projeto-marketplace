...
if ($_GET["acc"] == "check") {
    ...
    $pdo->query("UPDATE vendas SET ref_api = '$id_mercadopago' where id = '$id_conta'");

    // pix
    if($payment_method_id=="pix"){
       
    $pdo->query("UPDATE vendas SET forma_pgto = 'Pix' where id = '$id_conta'");
    ...
    if($payment_method_id=="bolbradesco"){
       ...
       $pdo->query("UPDATE vendas SET forma_pgto = 'Boleto' where id = '$id_conta'");
